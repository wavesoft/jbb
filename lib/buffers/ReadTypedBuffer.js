...
import ReadTypedBufferView from './ReadTypedBufferView';
import TypedBuffer from './TypedBuffer';

export default class ReadTypedBuffer extends TypedBuffer {

  /**
   * Constructs a new ReadTypedBuffer object that can be used to open
   ...
   * @returns {ReadTypedBufferView} Returns a view for accessing the items.
   */
  openView(viewType) {
    ...
    let view = new ReadTypedBufferView(this, viewType);
