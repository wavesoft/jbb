...
import WriteTypedBufferView from './WriteTypedBufferView';
import TypedBuffer from './TypedBuffer';

export default class WriteTypedBuffer extends TypedBuffer {

  /**
   * Constructs a new WriteTypedBuffer object that can be used for writing
   ...
   * @returns {WriteTypedBufferView} Returns a view for accessing the items.
   */
  openView(viewType) {
    ...
    let view = new WriteTypedBufferView(this, viewType);
