...
var count16 = 100000;
while (count16--) {
  ArrayAnalyser.analyzeNumericArray(ar_int);
};
...
var count16 = 100000;
while (count16--) {
  ArrayAnalyser.analyzeNumericArray(ar_bigint);
};
...
var count16 = 100000;
while (count16--) {
  ArrayAnalyser.analyzeNumericArray(ar_zero);
};
...
var count16 = 100000;
while (count16--) {
  ArrayAnalyser.analyzeNumericArray(ar_same);
};
