...
export default class WritableTypeBuffer extends TypeBuffer {

  /**
   * Constructs a new TypeIndex object that is responsible of keeping track
  ...
  /**
   * Get the underlaying buffer (read-only)
   *
   * @returns {ArrayBuffer} buffer - The buffer passed at the constructor
   */
  get buffer() {
    return this.buffer;
  }
