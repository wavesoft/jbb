...
import ReaddTypedBuffer from '../buffers/ReaddTypedBuffer';
...
export default class BufferedSparseReader extends BundleObject {
  ...
  constructor(buf8, buf16, buf32, buf64) {
    ...
    this.i8 = new ReaddTypedBuffer(buf8, 1);
    this.i16 = new ReaddTypedBuffer(buf16, 2);
    this.i32 = new ReaddTypedBuffer(buf32, 4);
    this.i64 = new ReaddTypedBuffer(buf64, 8);
