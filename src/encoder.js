 ...
 */
define(["three", "binary-search-tree", "fs", "util", "mock-browser", "colors", "mime", "three-bundles/lib/objects"], function(THREE, bst, fs, util, MockBrowser, colors, mime, ObjectTable) {
